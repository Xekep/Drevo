          ...
          {family.photos.map((photo) => (
            ...
            >
              ...
              <span>
                <b>{photo.title}</b>
                <small>
                  {photo.takenAt || "Дата неизвестна"} · Отметок:{" "}
                  {photo.tags.length}
                </small>
              </span>
            </button>
    ...
    <EditorDialog title={photo.title} onClose={onClose} wide>
      <div className="photo-viewer">
        <div className="photo-stage">
          ...
          >
            <img src={photo.url} alt={photo.title} draggable={false} />
            {photo.tags.map((tag) => {
          ...
          {canEdit && (
            <>
              ...
              <form
                ...
                onSubmit={async (e) => {
                  e.preventDefault();
                  await update({ ...photo, title, takenAt, description });
                }}
              >
                <label>
                  Название
